...
// CoconutPalm with Governance.
contract VitaminPalm is BEP20('VitaminToken', 'Vita') {
    ...
    // Safe cake transfer function, just in case if rounding error causes pool to not have enough PALMs.
