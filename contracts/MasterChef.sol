...
// MasterChef is the master of Fruit. He can farm Fruit and he is a fair guy.
//
...
contract MasterChef is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 accCakePerShare; // Accumulated Fruits per share, times 1e12. See below.
    }

    // The Fruit TOKEN!
    FruitToken public cake;
    // The Vita TOKEN!
    Vitamin public syrup;
    // Dev address.
    ...
    // Safe cake transfer function, just in case if rounding error causes pool to not have enough Fruits.
